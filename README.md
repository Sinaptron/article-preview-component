...
<div align="center" style="text-align: center">
 <h1><b>Article Preview Component<b></h1>  
<p>Article Preview Component, Este proyecto es parte del desafío #100daysofprojects promovido por:</p> 
...
- Visualizar opciones al hacer clic en el ícono compartir.

### _Importante:_
- Agregar icono favicon al proyecto.
- Renombrar URL fácil de recordar (ej. Article Preview Component ).
- Agregar título al proyecto (ej. Article Preview Component  - Frontend Club).
...
`>>>` : [Opcion 01](https://frontend-club.hashnode.dev/article-preview-component)<br>
